...
class GatewayTurnMixin:
    ...
    async def _hmwa_resolve_session(
        self, event, source, run_session_key: str | None = None, run_generation: int | None = None,
    ):
        ...
        if not strict_session and pinned_session_id:
            resolved_entry = await self._resolve_async_delegation_session(
                ...
                run_session_key=run_session_key, run_generation=run_generation,
            )

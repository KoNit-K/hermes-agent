...
class _FireOwnership:
    ...
    def lost(self) -> bool:
        claim_loss_signaled = self.claim_lost is not None and self.claim_lost.is_set()
        if isinstance(self.claim_lost, _CombinedCancelEvent):
            if self.claim_lost.other_cancel_is_set():
                return True
            claim_loss_signaled = self.claim_lost.fire_claim_is_set()

...
#: ``utils`` is a root module rather than a package, but post-update consumers import new
#: symbols from it (for example ``file_signature``), so it must leave the old module cache too.

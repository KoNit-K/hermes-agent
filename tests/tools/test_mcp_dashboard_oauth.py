...
def test_mcp_oauth_helpers_use_dashboard_flow_without_loopback_port():
    ...
    with dashboard_oauth_flow(flow):
        ...
        flow.deliver_callback(code="code-4", state="state-4", error=None, iss="https://idp.example")
        ...
        assert (result.code, result.state, result.iss) == ("code-4", "state-4", "https://idp.example")
